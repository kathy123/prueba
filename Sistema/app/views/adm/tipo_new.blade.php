                ...
                <div class="col-lg-12">
                    <section class="panel">
                        <header class="panel-heading">
                            Registrar Tipo de Postgrado
                        </header>
                        <div class="panel-body">
                            <div class=" form">
                                <form class="cmxform form-horizontal " id="commentForm" method="post" action="<?=URL::to('admi/tipopostsave');?>">
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Tipo de Programa</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="tipop"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Tipo de Trabajo</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="tipot"  type="text" required />
                                        </div>
                                    </div>
                                    <h6>CARGA HORARIA</h6>
                                    <fieldset>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Presenciales</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="tipot"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">No Presenciales</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="tipot"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Total</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="tipot"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Creditaje</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="tipot"  type="text" required />
                                        </div>
                                    </div>
