                    ...
                    <div class="panel-body">
                        <section id="unseen">
                            ...
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tbody>
                                <?php $i=1; ?>
                                   @foreach($postg as $postgrado)
                                <tr>
                                     <td>{{ $i }}</td>      
                                     <td>{{$postgrado->nombre}}</td>
                                     <td>{{$postgrado->estado}}</td>
                                     <td>{{$postgrado->tipo}}</td>
                                        <td><a class="btn btn-warning btn-xs" href= "{{'admi/tipopostedit/'.$postgrado->idpostgrado}}" title="editar postgrado"><i class="fa fa-edit"></i></a></td>
                                 <?php $i++; ?>
                                </tr>
                                @endforeach
                                </tbody>
