                            ...
                            <table class="table table-bordered table-striped table-condensed">
                                ...
                                <tr>
                                     ...
                                     <td>{{$usuario->username}}</td>
                                      ...
                                      <td>{{$usuario->tipo}}</td>
                                        <td>{{$usuario->idroles}}</td>
                                        <td><a class="btn btn-warning btn-xs" href= "{{'admi/usersedit/'.$usuario->id}}" title="editar usuario"><i class="fa fa-edit"></i></a>
                                         <a class="btn btn-danger btn-xs" href="{{'admi/usersbane/'.$usuario->id}}" title="dar de baja"><i class="fa fa-trash"></i></a></td>
                                 <?php $i++; ?>
                                </tr>
                                @endforeach
                                </tbody>
