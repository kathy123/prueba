                ...
                <div class="col-lg-12">
                    <section class="panel panel-primary">
                        <header class="panel-heading">
                            Registrar Grados Academicos de Postgrado
                        </header>
                        <div class="panel-body"> 
                            <div class="form">
                                <form class="cmxform form-horizontal" id="commentForm" method="post" action="<?=URL::to('admi/degreesave');?>">
                                    <fieldset>
                                    <div class="form-group">
                                        <label for="cname" class="control-label col-lg-3">Nombre del Grado Academico</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="nombre"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="cname" class="control-label col-lg-3">Otorga Grado Academico</label>
                                        <div class="col-lg-6">
                                               <select name="gradoa" class="form-control input-sm m-bot15" required> 
                                               <option>SI</option>
                                               <option>NO</option>
                                               </select>
                                        </div>
                                    ...
                                    <h6>CARGA HORARIA</h6>
                                    <div class="form-group">
                                        <label for="cname" class="control-label col-lg-3">Minimo de Horas Presenciales</label>
                                        <div class="col-lg-6">
                                            <input class="form-control" id="cname" name="hpm"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Minimo de Horas No Presenciales</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="hnpm"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Total de Horas</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="thm"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        <label for="cname" class="control-label col-lg-3">Trabajo Final</label>
                                        <div class="col-lg-6">
                                            <input class=" form-control" id="cname" name="trabajo_final"  type="text" required />
                                        </div>
                                    </div>
                                    <div class="form-group ">
