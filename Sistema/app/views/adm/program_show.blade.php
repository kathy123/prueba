...
@section('header')
    <?php
    echo HTML::style('assets/js/advanced-datatable/css/demo_page.css'); 
    echo HTML::style('assets/css/table-responsive.css');
    echo HTML::style('assets/js/advanced-datatable/css/demo_table.css');
    ?>
    @parent
@stop
                ...
                <section class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        ...
                        @if($prog)
                            ...
                            @else 
                            <h3>No hay tipos de postgrado registrado</h3>
                            @endif
                        </section>
                    </div>
...
@section('footer')
	@parent
  <?php 
   echo HTML::script('assets/js/advanced-datatable/js/jquery.dataTables.js');
   echo HTML::script('assets/js/data-tables/DT_bootstrap.js');
  ?>
@stop